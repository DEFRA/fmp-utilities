...
const epochCloseToMidnight = epochStartTime + MILLISECONDS.HOUR * halfDayHours // 04/06/2023 00:18:23 BST

const april12 = 1681337582000
const january01 = 1672534861001
const january23Midnight = 1769126400000
const january23Midday = 1769169600000
const december12 = 1701694799000
const timeZeroMinutes = 1769180400000
const november27 = 1764265080000
...
const resultIndexes = {
  formatUKTimeToMinuteFirst: 1,
  formatUKDateSecond: 2,
  formatUKDateTimeToMinuteThird: 3,
  formatUKDateTimeFourth: 4,
  formatUKDateTimeWithTimeZoneFifth: 5,
  formatUKTimeAndPauseTextSixth: 6
}

describe('dates', () => {
  describe.each([
    ['formatUKTimeToMinute', formatUKTimeToMinute, resultIndexes.formatUKTimeToMinuteFirst],
    ['formatUKDate', formatUKDate, resultIndexes.formatUKDateSecond],
    ['formatUKDateTimeToMinute', formatUKDateTimeToMinute, resultIndexes.formatUKDateTimeToMinuteThird],
    ['formatUKDateTime', formatUKDateTime, resultIndexes.formatUKDateTimeFourth],
    ['formatUKDateTimeWithTimeZone', formatUKDateTimeWithTimeZone, resultIndexes.formatUKDateTimeWithTimeZoneFifth],
    ['formatUKTimeAndPauseText', formatUKTimeAndPauseText, resultIndexes.formatUKTimeAndPauseTextSixth]
  ])('%s', (_functionName, dateFunction, expectedResultIndex) => {
  ...
  describe('formatUKTimeAndPauseText', () => {
    it('should format date correctly', () => {
      expect(formatUKTimeAndPauseText(november27)).toEqual('5:38pm on Thursday 27 November 2025')
    })

    it('should format midnight correctly', () => {
      expect(formatUKTimeAndPauseText(january23Midnight)).toEqual('midnight on Friday 23 January 2026')
    })

    it('should format midday correctly', () => {
      expect(formatUKTimeAndPauseText(january23Midday)).toEqual('midday on Friday 23 January 2026')
    })
